...
#
tclsqlite3:	$(TOP)/src/tclsqlite.c $(TOP)/src/test_mtperf.c $(TOP)/ext/recover/dbdata.c libsqlite3.a
	$(TCCX) $(TCL_FLAGS) -DSQLITE_CORE -DTCLSH -o tclsqlite3 \
                -DTCLSQLITE3_EXTRA_INIT=SqliteThreadTest_Init \
	$(TOP)/src/tclsqlite.c $(TOP)/src/test_mtperf.c $(TOP)/ext/recover/dbdata.c libsqlite3.a \
